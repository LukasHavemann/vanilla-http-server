...
public class ETag implements ProtocolRepresentation {
    ...
    public enum Kind {
        ...
        /**
         * A "weak validator" is representation metadata that might
        ...
        /**
         * Compares ETag according to <a href=https://tools.ietf.org/html/rfc7232#section-2.3.2">comparsion strategy</a>
         * <p>
         * +--------+--------+-------------------+-----------------+
