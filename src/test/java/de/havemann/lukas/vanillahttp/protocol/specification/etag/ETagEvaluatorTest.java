...
class ETagEvaluatorTest {
  ...
  void lastModifiedTest() {
    ...
    softly.assertThat(testee.isRequestLastModifiedOutdated(FIX_POINT_IN_TIME.plusDays(10)))
        .as("outdated").isTrue();
    softly.assertThat(testee.isRequestLastModifiedOutdated(FIX_POINT_IN_TIME)).as("equals test")
        .isFalse();
    softly.assertThat(testee.isRequestLastModifiedOutdated(FIX_POINT_IN_TIME.minusNanos(100)))
        .as("only second precision").isFalse();
    softly.assertThat(testee.isRequestLastModifiedOutdated(FIX_POINT_IN_TIME.minusDays(10)))
        .as("not outdated").isFalse();
    softly.assertAll();
  }
